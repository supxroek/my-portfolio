      ...
      <div className="max-w-6xl mx-auto px-6 pt-16">
        ...
        <div className="grid lg:grid-cols-[1fr_1.2fr] gap-16">
          ...
          >
            ...
            >
              Let's <span style={{ color: "#e5173f" }}>Work</span><br />Together
            </h2>
            <p className="text-muted-foreground mb-10 leading-relaxed" style={{ fontFamily: "'Inter', sans-serif" }}>
              I'm open to new opportunities and collaborations. Whether it's a freelance project, a full-time role, or just a chat — feel free to reach out.
            </p>

            <div className="space-y-4">
              {[
                { icon: Mail, label: "suparoek@example.com", href: "mailto:suparoek@example.com" },
                { icon: Github, label: "github.com/suparoek", href: "https://github.com/suparoek" },
                { icon: Instagram, label: "instagram/@suparoek", href: "https://instagram.com/suparoek" },
                { icon: Twitter, label: "x/@suparoek", href: "https://x.com/suparoek" },
                ...
                >
                  ...
                  >
                    <Icon size={15} style={{ color: "#6b6b6b" }} className="group-hover:text-[#e5173f] transition-colors duration-200" />
                  </div>
                  <span
          ...
          >
            {sent ? (
              <div
                ...
                style={{ borderColor: "rgba(0,196,124,0.3)", background: "rgba(0,196,124,0.05)" }}
              >
                <div className="text-3xl mb-4">✓</div>
                <div className="text-foreground mb-2" style={{ fontFamily: "'JetBrains Mono', monospace", fontWeight: 700 }}>
                  Message sent!
                </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <label className="block text-xs text-muted-foreground mb-2 uppercase tracking-widest" style={{ fontFamily: "'JetBrains Mono', monospace" }}>
                    Name
                  </label>
                  <input
                    type="text"
                    ...
                    style={inputStyle}
                    onFocus={e => (e.currentTarget.style.borderColor = "rgba(229,23,63,0.4)")}
      ...
      <div className="max-w-6xl mx-auto px-6 mt-20">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-8 pb-4">
          <span className="text-xs text-muted-foreground" style={{ fontFamily: "'JetBrains Mono', monospace" }}>
            © 2025 Suparoek Manajit. Built with React + Tailwind.
          </span>
          <div className="flex items-center gap-1 text-xs text-muted-foreground" style={{ fontFamily: "'JetBrains Mono', monospace" }}>
