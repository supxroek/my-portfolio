          ...
          <div className="hidden md:flex items-center gap-6">
            {navLinks.map(({ label, href }) => (
              <a
                ...
                onMouseEnter={(e) => {
                  if (active !== label) e.currentTarget.style.color = "#c0c0c0";
                }}
                onMouseLeave={(e) => {
                  if (active !== label) e.currentTarget.style.color = "#6b6b6b";
                }}
              >
                {active === label && (
                  <motion.span
              ...
              style={{
                ...
                border:
                  currentLang === "th"
                    ? "1px solid #e5173f"
                    : "1px solid transparent",
                color: currentLang === "th" ? "#e5173f" : "#6b6b6b",
              }}
            >
              TH
            </button>
              ...
              style={{
                ...
                border:
                  currentLang === "en"
                    ? "1px solid #e5173f"
                    : "1px solid transparent",
                color: currentLang === "en" ? "#e5173f" : "#6b6b6b",
              }}
            >
              EN
            </button>
