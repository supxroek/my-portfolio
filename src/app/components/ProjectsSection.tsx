...
const projects: Project[] = [
  {
    ...
    github: "https://github.com/suparoek",
    accent: "#6C63FF",
    featured: true,
    status: "Completed",
    image: "https://images.unsplash.com/photo-1720962158813-29b66b8e23e1?w=800&h=450&fit=crop&auto=format",
  ...
  },
  {
    ...
    accent: "#00C4CC",
    status: "In Progress",
    image: "https://images.unsplash.com/photo-1542831371-29b0f74f9713?w=800&h=450&fit=crop&auto=format",
  ...
  },
  {
    ...
    accent: "#02569B",
    status: "Completed",
    image: "https://images.unsplash.com/photo-1625838144804-300f3907c110?w=800&h=450&fit=crop&auto=format",
    ...
    >
      ...
      <div className="relative overflow-hidden" style={{ height: "180px", background: "#111" }}>
        <img
          ...
          style={{ transform: hovered ? "scale(1.05)" : "scale(1)", opacity: hovered ? 0.75 : 0.55 }}
        />
        {/* overlay gradient */}
        <div
        ...
        <div className="absolute top-3 left-3 flex gap-2 flex-wrap">
          ...
          <span
            ...
            style={{
              fontFamily: "'JetBrains Mono', monospace",
              background: project.status === "In Progress" ? "rgba(246,176,0,0.8)" : "rgba(0,196,124,0.8)",
              color: "#fff",
              letterSpacing: "0.05em",
              backdropFilter: "blur(4px)",
            }}
        ...
        <div className="absolute top-3 right-3 flex gap-2">
          {project.github && (
            <a
              ...
              style={{ background: "rgba(0,0,0,0.6)", color: "#c0c0c0", backdropFilter: "blur(4px)" }}
              onMouseEnter={e => { e.currentTarget.style.color = "#fff"; e.currentTarget.style.background = "rgba(0,0,0,0.85)"; }}
              onMouseLeave={e => { e.currentTarget.style.color = "#c0c0c0"; e.currentTarget.style.background = "rgba(0,0,0,0.6)"; }}
              aria-label="GitHub"
            >
              <Github size={13} />
            </a>
      ...
      <div className="p-5 flex flex-col flex-1">
        <h3
          ...
          style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: "1rem", fontWeight: 700 }}
        >
          {project.title}
        </h3>
        <p className="text-muted-foreground text-sm leading-relaxed mb-4 flex-1" style={{ fontFamily: "'Inter', sans-serif" }}>
          {project.longDesc}
        </p>
  ...
  return (
    <section id="projects" ref={ref} className="relative py-24 lg:py-32">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-16">
        ...
        >
          <a
            href="https://github.com/suparoek"
            className="inline-flex items-center gap-2 text-sm transition-colors duration-200"
            style={{ fontFamily: "'JetBrains Mono', monospace", color: "#6b6b6b" }}
            onMouseEnter={e => { e.currentTarget.style.color = "#e5173f"; }}
